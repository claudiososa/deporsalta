...
//Route::post('priceunit','SaleController@priceUnit')->middleware('auth')->name('preciounitario');

Route::post('/sale/price/unit/','SaleController@priceUnit')->middleware('auth')->name('priceunitario');
